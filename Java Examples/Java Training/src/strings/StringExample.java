...
public class StringExample {
    ...
    public static void main (String [] args) {
        ...
        System.out.println("using the endsWith method : "+string1.endsWith("sai"));
        System.out.println("Using the starts with method : "+string1.startsWith("Man"));
